      ...
      <ScrollReveal className="grid grid-cols-1 lg:grid-cols-3 gap-7">
        {articles.map((a) => (
          ...
          >
            ...
            <div className="pt-4 border-t border-[var(--celestial-gold-500-20)] flex items-center justify-between mt-auto">
              {a.author && (
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-[var(--celestial-gold-500-60)] bg-[var(--celestial-card)] flex items-center justify-center text-gold-300 font-cinzel text-xs font-bold shadow-[0_0_8px_rgba(212,175,55,0.3)]">
